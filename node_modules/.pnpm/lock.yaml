...
importers:
  ...
  .:
    devDependencies:
      ...
      vitest:
        specifier: ^1.0.0
        version: 1.6.1(@types/node@18.19.127)(jsdom@16.7.0)

  examples/browser-example:
    dependencies:
      '@calimero-network/mero-js':
        specifier: workspace:*
        version: link:../../packages/mero-js
...
snapshots:
  ...
  vite-node@1.6.1(@types/node@18.19.127):
    dependencies:
      cac: 6.7.14
      debug: 4.4.3
      pathe: 1.1.2
      picocolors: 1.1.1
      vite: 5.4.20(@types/node@18.19.127)
    transitivePeerDependencies:
      - '@types/node'
      - less
      - lightningcss
  ...
  vitest@1.6.1(@types/node@18.19.127)(jsdom@16.7.0):
    dependencies:
      '@vitest/expect': 1.6.1
      '@vitest/runner': 1.6.1
      '@vitest/snapshot': 1.6.1
