/* JavaScript SDK Docs — Shared Navigation + Full-text Search */
(function () {
  'use strict';

  const REPO = 'https://github.com/calimero-network/mero-js';
  const PAGES_BASE = './';

  const NAV = [
    { section: 'Overview' },
    { label: 'Home',            href: 'index.html',          dot: '#e3b341' },
    { label: 'Getting Started', href: 'getting-started.html',dot: '#a5ff11' },
    { section: 'Concepts' },
    { label: 'Architecture',    href: 'architecture.html',   dot: '#58a6ff' },
    { label: 'Error Model',     href: 'errors.html',         dot: '#f85149' },
    { section: 'Reference' },
    { label: 'API Reference',   href: 'api-reference.html',  dot: '#f778ba' },
    { label: 'Subscriptions',   href: 'subscriptions.html',  dot: '#39d0d8' },
  ];
    ...
    sb.innerHTML = `
      <div class="sidebar-logo">
        <div class="sidebar-logo-inner">
          ...
          <div class="sidebar-logo-text">
            <strong>Calimero <em>mero-js</em></strong>
      ...
      <div class="sidebar-footer">
        ...
        <div class="sidebar-footer-links">
          <a href="https://github.com/calimero-network/mero-js" target="_blank" rel="noopener">
